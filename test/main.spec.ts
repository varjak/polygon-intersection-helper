...
import {
  ...
  findAreaOfUnionOfPolygons,
  findIntersectionBetweenPolygons,
} from "../src/main";
import type { Polygon } from "../src/polygon-intersection-finder-types";
...
describe("findIntersectionBetweenPolygons", () => {
  ...
  describe("when polygon1 and polygon2 something something", () => {
    it("should intersect", () => {
      ...
      const isResultExpected = checkIfArraysOfPolygonsAreEqual(
        result,
        expectedResult,
      );
...
describe("findAreaOfUnionOfPolygons", () => {
  ...
  const polygon5: Polygon = [
    [1, 0.5],
    [2, 0.5],
    [2, 1.5],
    [1, 1.5],
  ];
  const polygon6: Polygon = [
    [0.5, 0.5],
    [1.5, 0.5],
    [1.5, 1.5],
    [0.5, 1.5],
