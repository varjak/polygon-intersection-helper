export function checkIfArraysOfPolygonsAreEqual(
  a: number[][][],
  b: number[][][],
) {
  if (a.length === b.length) {
    ...
    if (
      matchingPolygons1.every((e) => e === true) &&
      matchingPolygons2.every((e) => e === true)
    ) {
      return true;
    }
  }
...
function checkIfPointsAreEqual(a: number[], b: number[]) {
